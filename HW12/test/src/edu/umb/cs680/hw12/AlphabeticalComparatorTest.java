...
public class AlphabeticalComparatorTest {
    ...
    private static AlphabeticalComparator comparator;
    ...
    @Test
    public void asserAlphabeticalOrderGetImmediateChildrenTest() {
    ...
    @Test
    public void assertAlphabeticalOrderGetAllFilesTest() {
    ...
    @Test
    public void assertAlphabeticalOrderGetImmediateFileTest() {
